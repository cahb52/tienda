...
import { FormsModule, ReactiveFormsModule } from '@angular/forms'; //agregando componentes de formularios
import { HttpModule } from '@angular/http';
import { AngularFireModule } from 'angularfire2'; //agregando componentes de angularfire
